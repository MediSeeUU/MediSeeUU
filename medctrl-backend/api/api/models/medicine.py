...
class Medicine(models.Model):
    ...
    legal_basis = models.ForeignKey(LegalBasis, models.DO_NOTHING, blank=True, null=True)
    legal_scope = models.ForeignKey(LegalScope, models.DO_NOTHING, blank=True, null=True)
    atc_code = models.ForeignKey(AtcCode, models.DO_NOTHING, db_column='atc_code', blank=True, null=True)
