...
class MedicinalProduct(models.Model):
    ...
    eu_pnumber = create_dashboard_column(
        models.CharField(db_column="eu_pnumber", max_length=255, primary_key=True, null=False, blank=False),
    ...
    ema_url = create_dashboard_column(
        models.URLField(db_column="ema_url"),
        Category.General_Information,
        "link",
    ...
    ec_url = create_dashboard_column(
        models.URLField(db_column="ec_url"),
        Category.General_Information,
        "link",
    ...
    ema_number = create_dashboard_column(
        models.CharField(db_column="ema_number", max_length=255),
        Category.General_Information,
        "string",
    ...
    eu_med_type = create_dashboard_column(
        models.TextField(db_column="eu_med_type"),
        Category.General_Information,
        "string",
        "EU Medicine Type",
    )
