...
class Medicine(models.Model):
    ...
    atccode = models.ForeignKey(Lookupatccode, models.CASCADE, db_column='ATCCode', blank=True, null=True)
    activesubstance = models.ForeignKey(Lookupactivesubstance, models.CASCADE, db_column='ActiveSubstance', blank=True, null=True)
    newactivesubstance = models.IntegerField(db_column='NewActiveSubstance', blank=True, null=True)
    legalbasis = models.ForeignKey(Lookuplegalbasis, models.CASCADE, db_column='LegalBasis', blank=True, null=True)
    legalscope = models.ForeignKey(Lookuplegalscope, models.CASCADE, db_column='LegalScope', blank=True, null=True)
    atmp = models.IntegerField(db_column='ATMP', blank=True, null=True)
    medicinetype = models.ForeignKey(Lookupmedicinetype, models.CASCADE, db_column='MedicineType', blank=True, null=True)
    status = models.ForeignKey(Lookupstatus, models.CASCADE, db_column='Status', blank=True, null=True)
