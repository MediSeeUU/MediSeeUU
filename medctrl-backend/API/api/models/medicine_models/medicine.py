...
class Medicine(models.Model):
    ...
    test = models.CharField(db_column="test", max_length=45, blank=True, null=True)
    ...
    activesubstance = models.CharField(
        db_column="ActiveSubstance", max_length=255, null=True
    )
    ...
    legalbasis = models.CharField(
        db_column="LegalBasis", max_length=45, null=True
    )

    legalscope = models.CharField(
        db_column="LegalScope", max_length=45, null=True
    )
