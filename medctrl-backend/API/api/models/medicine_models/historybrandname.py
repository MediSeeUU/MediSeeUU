...
class Historybrandname(models.Model):
    """
    Model class for the brand name history table. As the abstract functionality for all model classes is nearly identical, information about them has been moved to an external readme. 
    """
