...
class Procedure(models.Model):
    ...
    proceduretype = models.ForeignKey(Lookupproceduretype, models.DO_NOTHING, db_column='ProcedureType', blank=True, null=True)
    ...
    decisionurl = models.CharField(db_column='DecisionURL', max_length=45, blank=True, null=True)
    annexurl = models.CharField(db_column='AnnexURL', max_length=45, blank=True, null=True)
