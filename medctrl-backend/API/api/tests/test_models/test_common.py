...
class DashboardColumnTestCase(TestCase):
    def test_create_dashboard_column1(self):
        ...
        self.assertEqual(field1.category, category1)
        self.assertEqual(field1.data_format, format1)
        self.assertEqual(field1.data_value, value1)
    ...
    def test_create_dashboard_column2(self):
        ...
        self.assertEqual(field2.category, category2)
        self.assertEqual(field2.data_format, format2)
        self.assertEqual(field2.data_value, value2)
