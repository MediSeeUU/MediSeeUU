...
from .lookupSerializers import LookupStatusSerializer, LookupAtccodeSerializer, LookupLegalscopeSerializer, LookupLegalbasisSerializer, LookupActiveSubstanceSerializer, LookupMedicinetypeSerializer, LookupRapporteurSerializer, LookupProceduretypeSerializer