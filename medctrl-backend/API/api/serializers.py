...
class MedicineSerializer(serializers.ModelSerializer):
    legal_basis = LegalBasisSerializer() #needs to be directly in legal_basis not legalbasis -> description
    legal_scope = LegalScopeSerializer() #needs to be directly in legal_scope not legalscope -> description
