...
class DummyListView(
    ...
    def get(request, dummy_id=None):
        if dummy_id:
            ...
            try:
                ...
                return Response(
                    {"errors": "This todo item does not exist."}, status=400
                )

            # Serialize todo item from Django queryset object to JSON formatted data
            read_serializer = DummySerializer(queryset)
            ...
            read_serializer = DummySerializer(queryset, many=True)
    ...
    def post(self, request):
        ...
        if create_serializer.is_valid():
            ...
            read_serializer = DummySerializer(todo_item_object)
    ...
    def put(request, dummy_id=None):
        ...
        update_serializer = DummySerializer(todo_item, data=request.data)
