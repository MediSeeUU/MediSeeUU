  ...
  return (
    <div class="procedure">
      ...
      <div class="procedure-content">
        <ProcedureDetail name="Decision Date" value={decisionDate} width="small-width" />
        <ProcedureDetail name="Procedure Type" value={procedureType} width="large-width" />
        <ProcedureDetail name="Decision Number" value={decisionNumber} width="small-width" />
      </div>
  
      <div class="procedure-files">
        <CustomLink 
          className="procedure-file-link" name="Annex File" 
          image="bx bx-file-blank" dest={annexURL} />
  
        <CustomLink 
          className="procedure-file-link" name="Decision File" 
          image="bx bx-file-blank" dest={decisionURL} />
      </div>
