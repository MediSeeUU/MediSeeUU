...
function InfoPage(props) {
  ...
  for (var i = 0; i < medicineData.procedures.length; i++) {
    allProcedures.push(
      <Procedure proc={medicineData.procedures[i]}/>
    );
  }
  ...
  return (
    <div>
      <Container>
        ...
        <div class="flex-columns">
          ...
          <DetailGroup title='General Information'>
            ...
            <Detail name="Marketing Authorisation Holder" value={medicineData.info.MAH}/>
            <Detail name="Active Substance" value={medicineData.info.ActiveSubstance}/>
            <Detail name="Decision Date" value={medicineData.info.DecisionDate}/>
          </DetailGroup>

          <DetailGroup title='Identifying Information'>
            <Detail name="Application Number" value={medicineData.info.ApplicationNo}/>
            <Detail name="EU Number" value={medicineData.info.EUNumber}/>
            <Detail name="Short EU Number" value={medicineData.info.EUNoShort}/>
          </DetailGroup>

          <DetailGroup title='Reporting Countries'>
            <Detail name="Primary Reporter" value={medicineData.info.Rapporteur}/>
            <Detail name="Secondary Reporter" value={medicineData.info.CoRapporteur}/>
          </DetailGroup>

          <DetailGroup title='Medicine Designations'>
            <Detail name="ATMP" value={medicineData.info.ATMP}/>
            <Detail name="Orphan Designation" value={medicineData.info.OrphanDesignation}/>
            <Detail name="NAS Qualified" value={medicineData.info.NASQualified}/>
          ...
          <DetailGroup title='ATC Code Information'>
            <Detail name="ATC Code Level 1" value={medicineData.info.ATCCodeL1}/>
            <Detail name="ATC Code Level 2" value={medicineData.info.ATCCodeL2}/>
            <Detail name="ATC Name Level 2" value={medicineData.info.ATCNameL2}/>
          </DetailGroup>
          ...
          <DetailGroup title='Authorisation Timing'>
            <Detail name="Accelerated Granted" value={medicineData.info.AcceleratedGranted}/>
            <Detail name="Accelerated Executed" value={medicineData.info.AcceleratedExecuted}/>
            <Detail name="Active Time Elapsed (days)" value={medicineData.info.ActiveTimeElapsed}/>
            <Detail name="Clock Stop Elapsed (days)" value={medicineData.info.ClockStopElapsed}/>
            <Detail name="Total Time Elapsed (days)" value={medicineData.info.TotalTimeElapsed}/>
          </DetailGroup>
      ...
      <Container> 
        ...
        <CustomLink className="external-link" name="EC Website" 
          dest="https://ec.europa.eu/info/index_en" />
        <CustomLink className="external-link" name="MEB Website" 
          dest="https://english.cbg-meb.nl/" />
        <CustomLink className="external-link" name="MAH Website" 
