...
export default function VariableSelect({ className, onChange, defaultValue, dataTestId }) {
  ...
  return (
    <select className={className} onChange={onChange} value={defaultValue} data-testid={dataTestId}>
      {optGroups}
    </select>
  )
}
