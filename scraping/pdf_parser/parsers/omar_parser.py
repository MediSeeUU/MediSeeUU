...
def parse_file(filepath: str, medicine_struct: pis.ParsedInfoStruct):
    ...
    for section in xml_body:
        ...
        if xml_utils.section_contains_header_substring_set_all(["comp", "adopted", "on", "final"], section) \
            ...
            final_attributes = {
                attr.eu_od_number: attribute_values.not_found,
                attr.ema_prevalence: attribute_values.not_found,
                attr.ema_alternative_treatments: attribute_values.not_found,
                attr.ema_significant_benefit: attribute_values.not_found,
                attr.ema_report_date: attribute_values.default_date
            }
...
def get_attributes(section: ET.Element, eu_od_flag: bool, pdf_file: str, xml_body: ET.Element) -> dict[str, str]:
    ...
    omar_attributes = {
        ...
        attr.eu_od_sig_benefit: get_significant_benefit(bullet_points, alternative_treatments, pdf_file),
