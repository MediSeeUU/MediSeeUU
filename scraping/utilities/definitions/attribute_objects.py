...
AttributeFactory(all_attributes, attr.eu_aut_type_initial, [src.decision_initial, src.annex_initial, src.web], acf.combine_best_source, acf.json_history_initial)
AttributeFactory(all_attributes, attr.eu_aut_type_current, [src.web], acf.combine_best_source, acf.json_history_current)
...
AttributeFactory(all_attributes, attr.aut_url, [src.file_dates], acf.combine_get_file_url, acf.json_history_current)
AttributeFactory(all_attributes, attr.smpc_url, [src.file_dates], acf.combine_get_file_url, acf.json_history_current)
AttributeFactory(all_attributes, attr.epar_url, [src.file_dates], acf.combine_get_file_url, acf.json_history_current)
...
# AttributeFactory(all_attributes, attr.eu_brand_name, [src.web], acf.combine_best_source, acf.json_history_current)
AttributeFactory(all_attributes, attr.eu_brand_name_current, [src.web], acf.combine_best_source, acf.json_history_current)
# AttributeFactory(all_attributes, attr.eu_brand_name_history, [src.web])
AttributeFactory(all_attributes, attr.eu_brand_name_initial, [src.decision_initial], acf.combine_best_source, acf.json_history_initial)
...
AttributeFactory(all_attributes, attr.eu_prime_initial, [src.epar], acf.combine_best_source, acf.json_history_initial)
...
# AttributeFactory(all_attributes, attr.ema_url, [src.file_dates], acf.combine_get_file_url, acf.json_history_current) #TODO: scrape links to webpages
# AttributeFactory(all_attributes, attr.ec_url, [src.file_dates], acf.combine_get_file_url, acf.json_history_current)
...
AttributeFactory(all_attributes, attr.eu_orphan_con_initial, [src.web], acf.combine_best_source, acf.json_history_initial)
...
AttributeFactory(all_attributes, attr.omar_url, [src.file_dates], acf.combine_get_file_url, acf.json_history_current)
# AttributeFactory(all_attributes, attr.odwar_url, [src.file_dates], acf.combine_get_file_url, acf.json_history_current) #TODO: add odwar
