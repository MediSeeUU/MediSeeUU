...
AttributeFactory(all_attribute_objects, attr.active_substance, [src.web, src.decision_initial], False,
                 acf.combine_select_string_overlap)
...
AttributeFactory(all_attribute_objects, attr.eu_aut_date, [src.web, src.decision_initial], False,
                 acf.combine_best_source)
AttributeFactory(all_attribute_objects, attr.eu_aut_type_initial, [src.decision_initial, src.annex_initial, src.web],
                 False, acf.combine_best_source, acf.json_history_initial)
AttributeFactory(all_attribute_objects, attr.eu_aut_type_current, [src.web], False, acf.combine_best_source,
                 acf.json_history_current)
...
AttributeFactory(all_attribute_objects, attr.aut_url, [src.decision_initial], False, acf.combine_get_file_url,
                 acf.json_history_current)
AttributeFactory(all_attribute_objects, attr.smpc_url, [src.annex_initial], False, acf.combine_get_file_url,
                 acf.json_history_current)
AttributeFactory(all_attribute_objects, attr.epar_url, [src.epar], False, acf.combine_get_file_url,
                 acf.json_history_current)
...
AttributeFactory(all_attribute_objects, attr.eu_brand_name_current, [src.web], False, acf.combine_best_source,
                 acf.json_history_current)
AttributeFactory(all_attribute_objects, attr.eu_brand_name_initial, [src.decision_initial], False,
                 acf.combine_best_source, acf.json_history_initial)
...
AttributeFactory(all_attribute_objects, attr.eu_mah_current, [src.web], False, acf.combine_best_source,
                 acf.json_history_current)
AttributeFactory(all_attribute_objects, attr.eu_mah_initial, [src.decision_initial], False, acf.combine_best_source,
                 acf.json_history_initial)
AttributeFactory(all_attribute_objects, attr.eu_prime_initial, [src.epar], False, acf.combine_best_source,
                 acf.json_history_initial)
# AttributeFactory(all_attribute_objects, attr.eu_prime_history, [src.epar]) #TODO: naar current?
AttributeFactory(all_attribute_objects, attr.eu_od_initial, [src.decision_initial], False, acf.combine_best_source,
                 acf.json_history_initial)
...
AttributeFactory(all_attribute_objects, attr.assess_time_days_active, [src.annex_10],
                 False, acf.combine_assess_time_days_active)
...
AttributeFactory(all_attribute_objects, attr.eu_orphan_con_current, [src.web], False, acf.combine_best_source,
                 acf.json_history_current)
...
AttributeFactory(all_attribute_objects, attr.omar_url, [src.omar], True, acf.combine_get_file_url,
                 acf.json_history_current)
AttributeFactory(all_attribute_objects, attr.odwar_url, [src.odwar], True, acf.combine_get_file_url,
                 acf.json_history_current)
...
AttributeFactory(all_attribute_objects, attr.eu_indication_initial, [src.annex_initial], False, acf.combine_best_source,
                 acf.json_history_initial)
