...
attribute_factory(objects, attr.chmp_opinion_date, [src.epar])
attribute_factory(objects, attr.eu_aut_date, [src.web, src.dec_initial], False, acf.combine_first)
attribute_factory(objects, attr.eu_aut_type_initial, [src.dec_initial, src.anx_initial, src.web], False,
                  acf.combine_first, acf.json_date)
attribute_factory(objects, attr.eu_aut_type_current, [src.web], False, acf.combine_first, acf.json_date)
...
attribute_factory(objects, attr.eu_brand_name_current, [src.web], False, acf.combine_first, acf.json_date)
attribute_factory(objects, attr.eu_brand_name_initial, [src.dec_initial], False, acf.combine_first, acf.json_date)
...
attribute_factory(objects, attr.eu_mah_current, [src.web], False, acf.combine_first, acf.json_date)
attribute_factory(objects, attr.eu_mah_initial, [src.dec_initial], False, acf.combine_first, acf.json_date)
attribute_factory(objects, attr.eu_prime_initial, [src.epar], False, acf.combine_first, acf.json_date)
attribute_factory(objects, attr.eu_od_initial, [src.dec_initial], False, acf.combine_first, acf.json_date)
...
attribute_factory(objects, attr.eu_orphan_con_current, [src.web], False, acf.combine_first, acf.json_date)
...
attribute_factory(objects, attr.eu_od_date, [src.web], True)
attribute_factory(objects, attr.eu_od_pnumber, [src.web], True)
attribute_factory(objects, attr.eu_od_sponsor, [src.web], True, acf.combine_first, acf.json_date)
attribute_factory(objects, attr.eu_od_comp_date, [src.dec_initial], True)
attribute_factory(objects, attr.eu_indication_initial, [src.anx_initial], False, acf.combine_first, acf.json_date)
