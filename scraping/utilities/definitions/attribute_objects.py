...
attribute_factory(objects, attr.eu_od_sponsor, [src.web], True)
...
# attribute_factory(objects, attr.eu_prime_history, [src.epar])
# attribute_factory(objects, attr.eu_od_history, [decision])
