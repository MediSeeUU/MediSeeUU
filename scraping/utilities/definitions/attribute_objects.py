...
# AttributeFactory(all_attribute_objects, attr.atc_name_l1, [src.web])
# AttributeFactory(all_attribute_objects, attr.atc_name_l2, [src.web])
# AttributeFactory(all_attribute_objects, attr.atc_name_l3, [src.web])
# AttributeFactory(all_attribute_objects, attr.atc_name_l4, [src.web])
...
AttributeFactory(all_attribute_objects, attr.eu_pnumber_id, [src.web])
...
# AttributeFactory(all_attribute_objects, attr.eu_brand_name, [src.web], acf.combine_best_source, acf.json_history_current)
...
# AttributeFactory(all_attribute_objects, attr.eu_brand_name_history, [src.web])
...
# AttributeFactory(all_attribute_objects, attr.eu_mah, )
...
# AttributeFactory(all_attribute_objects, attr.eu_mah_history, [src.web])
...
AttributeFactory(all_attribute_objects, attr.assess_time_days_total, [src.annex_10])
AttributeFactory(all_attribute_objects, attr.assess_time_days_active, [src.annex_10])
AttributeFactory(all_attribute_objects, attr.assess_time_days_cstop, [src.annex_10])
...
AttributeFactory(all_attribute_objects, attr.eu_orphan_con_initial, [src.web], acf.combine_best_source, acf.json_history_initial)
...
AttributeFactory(all_attribute_objects, attr.eu_od_comp_date, [src.web])
