...
# when a human medicine has an orphan linked to them:
eu_od_con_first = "eu_od_con_first"
eu_od_at_marketing = "eu_od_at_marketing"
eu_od_con_history = "eu_od_con_history"
