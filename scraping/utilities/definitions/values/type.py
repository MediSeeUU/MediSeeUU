...
# default_date_str = str(datetime.date.min())
date_not_found = generic_not_found
date_history_not_found = str(datetime.date.min())
...
#datetimes
# default_datetime = datetime.datetime.min()
# default_datetime_str = str(datetime.datetime.min())
datetime_not_found = generic_not_found
datetime_history_not_found = str(datetime.datetime.min())
