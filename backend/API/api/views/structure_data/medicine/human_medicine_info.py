...
class HumanMedicineInfo(views.APIView):
    ...
    def get(self, _):
        ...
        return Response(get_medicine_info(perm, models, [Category.Medicinal_product, Category.Ingredients_and_substances, Category.Marketing_authorisation, Category.Procedures]))
