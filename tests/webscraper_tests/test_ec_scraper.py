...
class TestEcScraper(TestCase):
    ...
    def test_scrape_medicines_list(self):
        url_list = ec.scrape_medicines_list("https://ec.europa.eu/health/documents/community-register/html/reg_hum_act.htm")
    ...
    def test_scrape_medicine_page(self):
        ...
        dec_result, anx_result, ema_result = ec.scrape_medicine_page(url)
